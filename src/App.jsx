    ...
    >
      <AnimatePresence mode="wait">
        ...
        >
          {type.aura === "fire" && (
            <motion.div
              animate={{ scale: [1, 1.16, 1], opacity: [0.8, 1, 0.85], rotate: [-4, 4, -4] }}
              transition={{ duration: 0.7, repeat: Infinity, ease: "easeInOut" }}
              className="absolute left-1/2 top-1/2 z-0 -translate-x-1/2 -translate-y-[60%] text-[165px] leading-none drop-shadow-[0_0_28px_rgba(249,115,22,0.9)]"
            >
              🔥
            </motion.div>
          )}
