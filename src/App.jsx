...
export default function BasketballGame() {
  ...
  return <Shell>{transitionOverlay}<div className="p-3 space-y-2 bg-slate-950 min-h-screen"><Card className="border border-slate-700 bg-slate-900"><motion.div animate={missShakeKey > 0 ? { x: missShakeKey % 2 === 0 ? [0, -8, 8, -6, 6, -3, 3, 0] : [0, 8, -8, 6, -6, 3, -3, 0], y: [0, 2, -2, 1, -1, 0] } : { x: 0, y: 0 }} transition={{ duration: 0.42, ease: "easeOut" }} className="relative w-full aspect-[390/485] overflow-hidden rounded-3xl border border-amber-900/40 bg-[#c98542]"><div className={`absolute left-2 top-2 ${courtTripOver ? "z-[82] rounded-2xl bg-slate-950/42 p-1 backdrop-blur-[1px]" : "z-30"} flex flex-col items-center gap-1 pointer-events-none`}>
