...
const BACK_RIM_TARGET = { x: 48.0, y: 3.8 };
const MAKE_DROP_TARGET = { x: 48.0, y: 11.5 };
  ...
  return (
    <div className="absolute inset-[-10px] pointer-events-none flex items-center justify-center">
      <motion.div
        ...
        className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-[66px] leading-none drop-shadow-[0_0_10px_rgba(249,115,22,0.55)]"
        style={{ zIndex: -1 }}
      >
        🔥
      </motion.div>
